...
PNG = ROOT / "03 Shirt Mockups" / "PNG Exports"
OUTPUT = ROOT / "07 Exports" / "PCC Tournament Polo Collection 2026 - Review Catalogue.pdf"
W, H = landscape(A3)
RED = HexColor("#d71920")
...
def page_frame(pdf, title, subtitle, page_number):
    ...
    pdf.drawRightString(W - 34, 18, f"CHECKERBOARD COLLECTION  |  PAGE {page_number}")
...
page_frame(
    pdf,
    "CHECKERBOARD TOURNAMENT POLOS - BLACK / RED / WHITE",
    "Solid black collars | solid alternate sleeve cuffs | corrected POLOKWANE back identity",
    1,
)
...
for index, colour in enumerate(("black", "red", "white")):
    ...
    half = (column - 28) / 2
    place(pdf, f"PCC-{colour}-front.png", x + 10, 85, half, H - 200)
    place(pdf, f"PCC-{colour}-back.png", x + 18 + half, 85, half, H - 200)
    pdf.setFillColor(GREY)
...
page_frame(
    pdf,
    "CHECKERBOARD LEADERSHIP POLOS",
    "Captain and manager variants | matching solid trim specification",
    2,
)
entries = [
    ("CAPTAIN - BLACK", "PCC-black-front-captain.png"),
    ("CAPTAIN - WHITE", "PCC-white-front-captain.png"),
    ("MANAGER - BLACK", "PCC-black-front-manager.png"),
    ("MANAGER - WHITE", "PCC-white-front-manager.png"),
]
gap = 15
