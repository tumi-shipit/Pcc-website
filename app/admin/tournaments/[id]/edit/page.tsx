  ...
  useEffect(() => {
    async function loadTournament() {
      ...
      if (error || !data) {
        ...
        setForm({
          ...
          tournament_type:
            ...
            data.tournament_type === "Provincial" ||
            data.tournament_type === "National" ||
            data.tournament_type === "Organisation / School"
      ...
      const { data: sectionData } = await supabase
        ...
        .select(
          "id, section_name, minimum_birth_year, maximum_birth_year, minimum_rating, maximum_rating, gender_restriction, entry_fee_override, maximum_players, chess_results_url, display_order"
        )
      ...
      if (sectionData && sectionData.length > 0) {
        setSections(
          sectionData.map((section) => ({
            ...
            chess_results_url: section.chess_results_url ?? "",
          }))
        );
      }
