        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h1 className="mt-3 text-4xl font-black">Newsroom Dashboard</h1>

              <p className="mt-3 max-w-3xl text-gray-400">
                Create announcements, live tournament updates, registration
                notices, reports and platform updates.
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="/images/news/photo.jpg or Supabase public URL"
                    className={inputClass}
                  />
                </div>
