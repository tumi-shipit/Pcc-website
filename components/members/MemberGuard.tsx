  ...
  useEffect(() => {
    async function checkMember() {
      ...
      const { data, error } = await supabase
        ...
        .select(
          "id, user_id, player_id, chess_sa_id, member_email, membership_type, membership_status, start_date, end_date, amount_paid, payment_reference, payment_date, payment_method, card_image_url, notes, verification_token, players(id, full_name, chess_sa_id, fide_id, rating, club, province, profile_photo_url, verification_status)"
        )
